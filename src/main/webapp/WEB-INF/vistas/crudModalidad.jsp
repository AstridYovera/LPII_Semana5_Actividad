										...
										<div class="panel-body">
											...
											<div class="form-group">
												<label class="col-lg-3 control-label"
													for="id_reg_num_hombres"># Hombres</label>
												<div class="col-lg-3">
													<input class="form-control" id="id_reg_num_hombres"
														name="numHombres"
														placeholder="Ingrese el número de hombres" type="text"
														maxlength="2" />
												</div>
											</div>
											<div class="form-group">
												<label class="col-lg-3 control-label"
													for="id_reg_num_mujeres"># Mujeres</label>
												<div class="col-lg-3">
													<input class="form-control" id="id_reg_num_mujeres"
														name="numMujeres"
														placeholder="Ingrese el número de mujeres" type="text"
														maxlength="2" />
												</div>
											</div>
											<div class="form-group">
												<label class="col-lg-3 control-label" for="id_reg_maxima">Edad
													Máxima</label>
												<div class="col-lg-3">
													<input class="form-control" id="id_reg_maxima"
														name="edadMaxima" placeholder="Ingrese la edad máxima"
														type="text" maxlength="2" />
												</div>
											</div>
											<div class="form-group">
												<label class="col-lg-3 control-label" for="id_reg_minima">Edad
													Mínima</label>
												<div class="col-lg-3">
													<input class="form-control" id="id_reg_minima"
														name="edadMinima" placeholder="Ingrese la edad mínima"
														type="text" maxlength="2" />
												</div>
											</div>
											<div class="form-group">
												...
												<div class="col-lg-8">
													<input class="form-control" id="id_reg_sede" name="sede"
														placeholder="Ingrese la sede" type="text" maxlength="20" />
												</div>
											</div>
											<div class="form-group">
												<label class="col-lg-3 control-label" for="id_reg_deporte">Deporte</label>
												<div class="col-lg-3">
													<select id="id_reg_deporte" name="deporte"
														class='form-control'>
								...
								<div class="panel panel-default">
									...
									<div id="stepOne" class="panel-collapse collapse in">
										<div class="panel-body">
											<div class="form-group">
												...
												<div class="col-lg-8">
													<input class="form-control" id="id_ID" readonly="readonly"
														name="idModalidad" type="text" maxlength="8" />
												</div>
											</div>
											<div class="form-group">
											...
											<div class="form-group">
												<label class="col-lg-3 control-label" for="id_num_hombres">#
													Hombres</label>
												<div class="col-lg-3">
													<input class="form-control" id="id_act_num_hombres"
														name="numHombres"
														placeholder="Ingrese el número de hombres" type="text"
														maxlength="2" />
												</div>
											...
											<div class="form-group">
												<label class="col-lg-3 control-label" for="id_num_mujeres">#
													Mujeres</label>
												<div class="col-lg-3">
													<input class="form-control" id="id_act_num_mujeres"
														name="numMujeres"
														placeholder="Ingrese el número de mujeres" type="text"
														maxlength="2" />
												</div>
											...
											<div class="form-group">
												<label class="col-lg-3 control-label" for="id_maxima">Edad
													Máxima</label>
												<div class="col-lg-3">
													<input class="form-control" id="id_act_maxima"
														name="edadMaxima" placeholder="Ingrese la edad máxima"
														type="text" maxlength="2" />
												</div>
											</div>
											<div class="form-group">
												<label class="col-lg-3 control-label" for="id_minima">Edad
													Mínima</label>
												<div class="col-lg-3">
													<input class="form-control" id="id_act_minima"
														name="edadMinima" placeholder="Ingrese la edad mínima"
														type="text" maxlength="2" />
												</div>
											</div>
											<div class="form-group">
												...
												<div class="col-lg-8">
													<input class="form-control" id="id_act_sede" name="sede"
														placeholder="Ingrese la sede" type="text" maxlength="20" />
												</div>
											</div>
											<div class="form-group">
												...
												<div class="col-lg-3">
													<select id="id_act_deporte" name="deporte"
														class='form-control'>
														<option value=" ">[Seleccione]</option>
													</select>
												</div>
	...
	<script type="text/javascript">
		$.getJSON("listaDeporte", {}, function(data) {
			$.each(data, function(i, item) {
				$("#id_reg_deporte").append(
						"<option value="+item.idDeporte +">" + item.nombre
								+ "</option>");
				$("#id_act_deporte").append(
						"<option value="+item.idDeporte +">" + item.nombre
								+ "</option>");
			});
		});
		...
		function editar(id, nombre, numHombres, numMujeres, edadMaxima,
				edadMinima, sede, idDeporte) {
			$('#id_ID').val(id);
